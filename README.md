...
| 파일 | 설명 |
|------|------|
| [`INFX_CODING_STYLE_GUIDE.md`](INFX_CODING_STYLE_GUIDE.md) | 전반적인 코드 작성 규칙 및 패턴 |
| [`INFX_PYTHON_CODING_STYLE_GUIDE.md`](INFX_PYTHON_CODING_STYLE_GUIDE.md) | Python 특화 코딩 규칙 및 패턴 |
...
| [`INFX_DEV_INFRASTRUCTURE_GUIDE.md`](INFX_DEV_INFRASTRUCTURE_GUIDE.md) | 개발 환경 세팅 및 인프라 상세 |
...
### 항상 참조할 가이드
- 코딩 스타일: C:/dev/infx/infx_dev_guide/INFX_CODING_STYLE_GUIDE.md
- Python 규칙: C:/dev/infx/infx_dev_guide/INFX_PYTHON_CODING_STYLE_GUIDE.md
...
| 작업 내용 | 참조할 가이드 |
|-----------|--------------|
| 일반 Python 코드 작성 | `INFX_CODING_STYLE_GUIDE.md`, `INFX_PYTHON_CODING_STYLE_GUIDE.md` |
...
2. [`INFX_CODING_STYLE_GUIDE.md`](INFX_CODING_STYLE_GUIDE.md) — 기본 코딩 규칙 숙지
3. [`INFX_PYTHON_CODING_STYLE_GUIDE.md`](INFX_PYTHON_CODING_STYLE_GUIDE.md) — Python 세부 규칙 숙지
4. 담당 모듈에 맞는 가이드 추가 학습
